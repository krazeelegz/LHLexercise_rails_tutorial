...
As you've probably noticed, this tutorial is divided into handy [commits](https://github.com/lighthouse-labs/lighthouse_forum/commits/master) for not only organization, but also to give you a reference as you work.
